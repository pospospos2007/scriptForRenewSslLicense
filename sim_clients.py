...
def parse_cmdline_args():
    ...
    optional.add_argument(
        '-n', 
        default='microwave_temperature_sensor',
    ...
    optional.add_argument(
        '--broker-ip', 
        default="192.168.192.129",
        dest='broker_ip',
        help='ip address of the MQTT broker.\nDefault is 192.168.192.129'
    )
...
clients=[]
topicsNameofFile=[
'microwave_temperature_sensor',
'refrigerator_temperature_sensor',
'pressure_sensor',
'store_heatmap_sensor',
'garbage_bin_sensor',
'proximity_sensor'
]
...
for i in range(clients_num):
    ...
    client_name = topicsNameofFile[i]
...
# python3 sim_clients.py -c 1 -n microwave_temperature_sensor -i 30
